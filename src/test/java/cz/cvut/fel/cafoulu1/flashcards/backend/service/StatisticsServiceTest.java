...
public class StatisticsServiceTest {
    ...
    void incrementWantedStatistics_incrementsBothStatisticsWhenSecondStatIsProvided() {
        ...
        statisticsService.incrementWantedStatistics(cardSetId, userId, firstStat, secondStat);
    ...
    void incrementWantedStatistics_throwsExceptionWhenSetStatisticsNotFound() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> statisticsService.incrementWantedStatistics(cardSetId, userId, firstStat, secondStat));
